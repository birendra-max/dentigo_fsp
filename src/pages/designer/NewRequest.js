                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    {[
                      ...
                      {
                        count: files.filter(f => f.uploadStatus === "Uploading..." || f.uploadStatus === "Processing...").length,
                        label: "In Progress",
                        gradient: "from-yellow-500 to-yellow-600"
                      },
                      {
                        count: files.filter(f => f.uploadStatus === "Queued" || f.uploadStatus === "Multiple Orders Found").length,
                        label: "Pending",
