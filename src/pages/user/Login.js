...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#041421] p-4">
            <div className="w-full max-w-[1200px] h-auto lg:h-[470px] bg-[#042333] rounded-xl border border-cyan-400/40 shadow-[0_0_25px_rgba(0,255,255,0.4)] overflow-hidden flex flex-col lg:flex-row relative">
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center relative z-20 px-6 py-10">
                    <div className="w-full max-w-[400px] text-white">
                        <h2 className="text-3xl font-bold text-center mb-8">Client Login</h2>

                        {status.message && (
                            <div className={`text-center text-sm mb-4 ${status.type === "error" ? "text-red-400" : "text-green-400"}`}>
                                {status.message}
                            </div>
                        )}
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-gradient-to-b from-[#33deff] to-[#0aa3bf] 
                                           text-white rounded-full shadow-lg disabled:opacity-50">
                ...
                {/* RIGHT PANEL – CENTERED + SKEW */}
                <div className="w-full lg:w-1/2 bg-black relative flex items-center justify-center overflow-hidden py-10 px-4">
                    {/* Skew triangle only for large screens */}
                    <div className="hidden lg:block absolute left-0 top-0 w-0 h-0 
                        border-t-[470px] border-t-[#042333] 
                        border-r-[100px] border-r-transparent z-10"></div>
